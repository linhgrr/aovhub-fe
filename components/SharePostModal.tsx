          ...
          <div className="border border-white/10 rounded-[16px] overflow-hidden bg-bg-main/30">
            ...
            {displayPost.media && displayPost.media.length > 0 && (
              <div className="px-4 pb-4">
                <div className={`grid gap-1.5 ${displayPost.media.length === 1 ? 'grid-cols-1' :
                  ...
                  {displayPost.media.map((item, index) => (
                    <div
                      key={index}
                      className={`relative rounded-[12px] overflow-hidden border border-white/5 bg-black/20 ${displayPost.media.length === 1 ? 'aspect-video' : 'aspect-square'
                        }`}
                    >
                      {item.type === 'image' ? (
                        <img
